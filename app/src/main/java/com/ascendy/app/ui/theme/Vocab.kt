 ...
 *
 * The constructor is near the JVM's 255-argument limit — see [ChartVocab] and
 * VocabTest.constructorArguments_stayUnderJvmLimit before adding fields.
 */
data class Vocab(
    // top-level
    val appTitle: String,
...
val KawaiiVocab = Vocab(
    ...
    permsOverlayBody = "lets the kawaii block screen pop over blocked apps — if accessibility is off, this is what keeps blocking working ♡",
...
val ToughVocab = Vocab(
    ...
    permsOverlayBody = "the block screen covers blocked apps the moment they surface. without accessibility, this is the only thing that does.",
    permsNotificationsEmoji = "▲",
    permsNotificationsTitle = "NOTIFICATIONS",
...
val NeutralVocab = Vocab(
    ...
    permsOverlayEmoji = "",
    permsOverlayTitle = "Display over other apps",
    permsOverlayBody = "Allows the block screen to appear over blocked apps. Required for app blocking when accessibility is off (Android 10+).",
    permsNotificationsEmoji = "",
    permsNotificationsTitle = "Notifications",
